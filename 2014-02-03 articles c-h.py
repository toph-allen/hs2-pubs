...
articlepaths = get_article_paths('/Users/toph/PMC Articles/articles.C-H')
...
affcounts.to_csv(outdir + 'matched_places_aff c-h.csv', encoding = 'utf-8')
...
pcounts.to_csv(outdir + 'matched_places_p c-h.csv', encoding = 'utf-8')
t2 = datetime.datetime.now()
tdp = t2 - t1
tdp
